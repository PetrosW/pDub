...
class Record : public QWidget
{
    ...
    Q_PROPERTY(uint32_t VolumeNormalized READ VolumeNormalized WRITE setVolumeNormalized NOTIFY volumeNormalizedChanged)
    ...
    public:
        ...
        uint32_t VolumeNormalized() { return m_VolumeNormalized; }
    ...
    private:
        ...
        void setVolumeNormalized(const uint32_t &a) { m_VolumeNormalized = a; volumeNormalizedChanged(); }
    ...
    signals:
        ...
        void onMouseRelease(uint32_t RecordID, uint32_t StartTime, uint32_t EndTime, QString Name, uint32_t Volume);
        void onMousePress(uint32_t RecordID, uint32_t StartTime, uint32_t EndTime, QString Name, uint32_t Volume);
        void onMouseMove(uint32_t RecordID, uint32_t StartTime, uint32_t EndTime, QString Name, uint32_t Volume);
